        ...
        {overviewModules.map((module) => (
          ...
          >
            ...
            <button
              ...
              className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-[26px] bg-[#18aead] px-4 py-2 text-sm font-semibold text-[#041226] transition hover:brightness-110"
            >
              Open
