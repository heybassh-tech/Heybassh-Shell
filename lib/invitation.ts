  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #0b1124; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #3ab0ff;">You've been invited!</h2>
        <p>You've been invited to join <strong>${companyName}</strong> on Heybassh Shell.</p>
        <p>Click the button below to create your account and get started:</p>
        <p style="margin: 24px 0;">
          <a href="${inviteUrl}" style="background: #3ab0ff; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-block; font-weight: bold;">Accept Invitation</a>
        </p>
        ...
        <p style="color: #666; font-size: 14px;">Or copy and paste this link into your browser:<br><a href="${inviteUrl}" style="color: #3ab0ff; word-break: break-all;">${inviteUrl}</a></p>
      </div>
    `,
  }
